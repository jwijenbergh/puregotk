...
import "github.com/jwijenbergh/puregotk/v4/gmodule"
...
type PixbufModuleBeginLoadFunc func(uintptr, uintptr, uintptr, uintptr) uintptr
...
type PixbufModuleIncrementLoadFunc func(uintptr, uintptr, uint) bool
...
type PixbufModuleLoadAnimationFunc func(uintptr) uintptr

// Loads a file from a standard C file stream into a new `GdkPixbuf`.
//
// In case of error, this function should return `NULL` and set the `error` argument.
type PixbufModuleLoadFunc func(uintptr) uintptr
...
// data.
type PixbufModuleSaveCallbackFunc func(uintptr, uintptr, uintptr, uintptr, uintptr) bool
...
// values (in the same order) for attributes to be saved alongside the image
// data.
type PixbufModuleSaveFunc func(uintptr, uintptr, uintptr, uintptr) bool
...
type PixbufModuleStopLoadFunc func(uintptr) bool
