...
type DatagramBased interface {
	...
	ReceiveMessages(MessagesVar uintptr, NumMessagesVar uint, FlagsVar int32, TimeoutVar int64, CancellableVar *Cancellable) int32
	SendMessages(MessagesVar uintptr, NumMessagesVar uint, FlagsVar int32, TimeoutVar int64, CancellableVar *Cancellable) int32
}
...
// other error.
func (x *DatagramBasedBase) ReceiveMessages(MessagesVar uintptr, NumMessagesVar uint, FlagsVar int32, TimeoutVar int64, CancellableVar *Cancellable) int32 {
...
func (x *DatagramBasedBase) SendMessages(MessagesVar uintptr, NumMessagesVar uint, FlagsVar int32, TimeoutVar int64, CancellableVar *Cancellable) int32 {
...
var XGDatagramBasedReceiveMessages func(uintptr, uintptr, uint, int32, int64, uintptr) int32
var XGDatagramBasedSendMessages func(uintptr, uintptr, uint, int32, int64, uintptr) int32
