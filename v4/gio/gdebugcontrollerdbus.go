...
func (x *DebugControllerDBus) ConnectAuthorize(cb func(DebugControllerDBus, uintptr) bool) {
	...
	gobject.ObjectConnect(x.GoPointer(), "signal::authorize", purego.NewCallback(fcb))
}
