...
func (x *PageSetupUnixDialog) UpdatePropertyValue(NPropertiesVar int32, PropertiesVar uintptr, ValuesVar uintptr) {
...
//
// This function is meant to be used by language bindings.
func (x *PageSetupUnixDialog) UpdateRelationValue(NRelationsVar int32, RelationsVar uintptr, ValuesVar uintptr) {
...
//
// This function is meant to be used by language bindings.
func (x *PageSetupUnixDialog) UpdateStateValue(NStatesVar int32, StatesVar uintptr, ValuesVar uintptr) {
