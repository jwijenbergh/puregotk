...
func (x *Button) ConnectActivate(cb func(Button)) {
...
func (x *Button) ConnectClicked(cb func(Button)) {
	fcb := func(clsPtr uintptr) {
		fa := Button{}
		fa.Ptr = clsPtr
...
func (x *Button) UpdatePropertyValue(NPropertiesVar int32, PropertiesVar uintptr, ValuesVar uintptr) {
...
//
// This function is meant to be used by language bindings.
func (x *Button) UpdateRelationValue(NRelationsVar int32, RelationsVar uintptr, ValuesVar uintptr) {
...
//
// This function is meant to be used by language bindings.
func (x *Button) UpdateStateValue(NStatesVar int32, StatesVar uintptr, ValuesVar uintptr) {
