...
func NewvListStore(NColumnsVar int32, TypesVar uintptr) *ListStore {
	...
	NewvListStoreCls := &ListStore{}
	NewvListStoreCls.Ptr = NewvListStorePtr
	return NewvListStoreCls
}
...
func (x *ListStore) IterIsValid(IterVar *TreeIter) bool {
	...
	return xListStoreIterIsValid(x.GoPointer(), IterVar)
...
func (x *ListStore) Remove(IterVar *TreeIter) bool {
	...
	return xListStoreRemove(x.GoPointer(), IterVar)
