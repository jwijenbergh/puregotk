// Package mylibmeson was automatically generated by github.com/jwijenbergh/puregotk DO NOT EDIT
package mylibmeson
...
func init() {
	core.SetPackageName("MYLIBMESON", "mylib-meson-0.1")
	core.SetSharedLibraries("MYLIBMESON", []string{"libmylib-meson-0.1.so"})
	var libs []uintptr
	for _, libPath := range core.GetPaths("MYLIBMESON") {
	...
	core.PuregoSafeRegister(&xMainApplicationWindowGLibType, libs, "mylib_meson_main_application_window_get_type")

	core.PuregoSafeRegister(&xMainApplicationWindowShowToast, libs, "mylib_meson_main_application_window_show_toast")
